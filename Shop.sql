...
DROP FOREIGN KEY Products_Categories_FK;
ALTER TABLE Orders
DROP FOREIGN KEY Orders_CustomersId_FK;
ALTER TABLE ProductsOrder
DROP FOREIGN KEY ProductsOrder_Orders_FK;
ALTER TABLE ProductsOrder
DROP FOREIGN KEY ProductsOrder_Products_FK;
